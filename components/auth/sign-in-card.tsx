        ...
        <form className="mt-8 space-y-6" onSubmit={handlerCredentialSignin}>
          <div className="space-y-4">
            <div className="group relative">
              <Input
                ...
                autoComplete="email"
                required
                className="focus::ring-green-500 focs:border-green-500 block w-full rounded-lg border-green-500/50 bg-black/50 text-white placeholder-gray-500 backdrop-blur-sm transition-all duration-300 group-hover:border-green-400"
          ...
          <div>
            <Button
              disabled={pending}
              type="submit"
              className="foucse:ring-2 focus-green-500 w-full transform rounded-lg bg-gradient-to-r from-green-500 to-green-600 px-4 py-3 font-semibold text-black transition-all duration-300 ease-in-out hover:scale-105 hover:from-green-600 hover:to-green-700 focus:outline-none focus:ring-opacity-50"
            >
